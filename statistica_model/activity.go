...
//
//
//void _BTrees_Prediction_T12_52_9(
//      const double * _x__,
//      const double * _y__,
//      const double * _z__,
//      const double * _x1__,
...
func (a *ModelActivity) Eval(context activity.Context) (done bool, err error) {
	...
	var result C.char
	C._BTrees_Prediction_T12_52_9(&i1, &i2, &i3, &i4, &i5, &i6, &i7, &i8, &i9, &i10, &i11, &i12, &i13, &i14, &i15, &i16, &i17, &i18, &i19, &i20, &i21, &i22, &i23, &i24, &i25, &i26, &i27, &i28, &i29, &i30, &i31, &i32, &i33, &result)
